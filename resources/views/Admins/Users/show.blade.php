...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl text-gray-800 leading-tight">
            {{ $isEdit ? __('Edit User') : __('Tambah User') }}
        </h2>
    </x-slot>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
            <form action="{{ $isEdit ? route('users.update', $user->id) : route('users.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input name="first_name" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200"
                ...
                <div class="mb-6">
                    ...
                    <input name="last_name" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200"
                ...
                <div class="mb-6">
                    ...
                    <input name="email" type="email" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200 {{ $isEdit ? 'bg-gray-100 cursor-not-allowed' : '' }}"
                        value="{{ old('email', $user->email ?? '') }}" {{ $isEdit ? 'readonly' : '' }}>
                    @error('email')
                        <div class="flex items-center text-red-600 text-sm mt-2 animate-fade-in">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                ...
                <div class="mb-6">
                    ...
                    <input type="date" name="dob" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200"
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        <input 
                            ...
                            name="password" 
                            id="password" 
                            class="w-full border border-gray-300 p-3 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200 bg-blue-50" 
