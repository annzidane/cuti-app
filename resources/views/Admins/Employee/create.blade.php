        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
            <form action="{{ route('employees.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input name="phone_number" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200"></input>
                    @error('phone_number')
                        <div class="flex items-center text-red-600 text-sm mt-2 animate-fade-in">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                ...
                <div class="mb-6">
                    ...
                    <input name="address" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition duration-200"></input>
                    @error('address')
                        <div class="flex items-center text-red-600 text-sm mt-2 animate-fade-in">
                            <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('employees.index') }}" class="text-blue-600 px-6 py-2 rounded-lg border border-blue-600 hover:bg-blue-50 transition duration-200">
                        Kembali
                    </a>
                </div>
            </form>
